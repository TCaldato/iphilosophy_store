...
def cache_checkout_data(request):
    """Handles caching of data related to the checkout process."""
    try:
...
def checkout(request):
    """Handles the display and submission of the checkout form."""
    ...
    if request.method == "POST":
        ...
        # Create a form instance with POST data and validate
        ...
        # Pre-fill the form with known user info if user is authenticated
...
def checkout_success(request, order_number):
    """
    Handles successful checkout processes
    """
